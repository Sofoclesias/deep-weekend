"""
Fuente original: https://github.com/Natooz/MidiTok/blob/main/miditok/constants.py
"""
...
BOS_TOKEN_NAME = "BOS"
EOS_TOKEN_NAME = "EOS"
SPECIAL_TOKENS = [BOS_TOKEN_NAME, EOS_TOKEN_NAME]
MANDATORY_SPECIAL_TOKENS = [BOS_TOKEN_NAME, EOS_TOKEN_NAME]
